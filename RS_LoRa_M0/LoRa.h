...
void SendInfoMessage(char *msgtext)
{
  ...
  strcpy (msgbuf, "NCS");
  // Message type,
  sprintf (msgbuf+strlen(msgbuf), "RS1,"); // RS is type of device sent the message(Rain Gauge) and the 2 is the message format of what follows
  
  // Rain Gauge Station ID
